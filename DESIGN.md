...
colors:
  dark:
    ...
    accent-hover: "#8A8ED9"
    accent-soft: "rgba(127, 130, 212, 0.12)"
    accent-soft-foreground: "#9FA3E1"
    danger: "#DB3C33"
    success: "#00CA6C"
    warning: "#F4B94D"
    border: "#28292A"
    ...
    snow: "#FCFCFC"
    white: "#FFFFFF"
    accent-soft-hover: "rgba(127, 130, 212, 0.16)"
    ...
    danger-hover: "#E15549"
    danger-soft: "rgba(219, 60, 51, 0.15)"
    danger-soft-foreground: "#EB796B"
    danger-soft-hover: "rgba(219, 60, 51, 0.2)"
    ...
    success-hover: "#18B664"
    success-soft: "rgba(0, 202, 108, 0.12)"
    success-soft-foreground: "#72D994"
    success-soft-hover: "rgba(0, 202, 108, 0.16)"
    ...
    warning-hover: "#DBA74A"
    warning-soft: "rgba(244, 185, 77, 0.12)"
    warning-soft-foreground: "#F7CC85"
    warning-soft-hover: "rgba(244, 185, 77, 0.16)"
  light:
    ...
    accent-foreground: "#FCFCFC"
    accent-hover: "#8A8ED9"
    accent-soft: "rgba(127, 130, 212, 0.15)"
    accent-soft-foreground: "#5D6097"
    danger: "#FF392D"
    success: "#00CA6C"
    warning: "#F2A71A"
    border: "#DDDEE0"
    ...
    snow: "#FCFCFC"
    white: "#FFFFFF"
    accent-soft-hover: "rgba(127, 130, 212, 0.2)"
    ...
    danger-foreground: "#FCFCFC"
    danger-hover: "#FF5647"
    danger-soft: "rgba(255, 57, 45, 0.15)"
    danger-soft-foreground: "#A4352D"
    danger-soft-hover: "rgba(255, 57, 45, 0.2)"
    ...
    success-foreground: "#18181B"
    success-hover: "#18B664"
    success-soft: "rgba(0, 202, 108, 0.15)"
    success-soft-foreground: "#297849"
    success-soft-hover: "rgba(0, 202, 108, 0.2)"
    surface-foreground: "#18181B"
    surface-hover: "#EAEAEA"
    surface-secondary-foreground: "#18181B"
    surface-tertiary-foreground: "#18181B"
    warning-foreground: "#18181B"
    warning-hover: "#D99723"
    warning-soft: "rgba(242, 167, 26, 0.15)"
    warning-soft-foreground: "#84602C"
    warning-soft-hover: "rgba(242, 167, 26, 0.2)"
typography:
  xs:
    fontFamily: "Figtree"
    fontSize: "12px"
...
components:
  button-danger:
    backgroundColor: "#FF392D"
    component: "Button variant=\"danger\""
    textColor: "#FCFCFC"
  button-primary:
    backgroundColor: "#7F82D4"
...
| `muted` | `#717276` | `#9F9FA4` | `Light: oklch(55.17% 0.0060 280.76); Dark: oklch(70.50% 0.0060 280.76)` | `--muted` | `text-muted` | Secondary text color for less prominent content like placeholders and captions. |
...
| `accent` | `#7F82D4` | `#7F82D4` | `oklch(63.92% 0.1219 280.76)` | `--accent` | `Button variant="primary"` or `bg-accent text-accent-foreground` | Primary brand color. Used for key actions, highlights, and moments of emphasis. |
...
| `accent-hover` | `#8A8ED9` | `#8A8ED9` | `accent / 90% + accent-foreground / 10%` | `--accent-hover` | Prefer HeroUI hover states; use `bg-accent-hover` only for custom surfaces | Accent hover state. Derived automatically from accent and accent-foreground. |
| `accent-soft` | `rgba(127, 130, 212, 0.15)` | `rgba(127, 130, 212, 0.12)` | `Light: accent / 15% + transparent; Dark: accent / 12% + transparent` | `--accent-soft` | `bg-accent-soft text-accent-soft-foreground` for selected or soft emphasis | Subtle accent background. A low-opacity tint for soft emphasis and selections. |
| `accent-soft-foreground` | `#5D6097` | `#9FA3E1` | `Light: accent / 70% + foreground / 30%; Dark: accent / 80% + foreground / 30%` | `--accent-soft-foreground` | Prefer the HeroUI token for accent-soft-foreground. | Text color on accent-soft backgrounds. Mixed from accent and foreground for accessible contrast. |
| `danger` | `#FF392D` | `#DB3C33` | `Light: oklch(65.32% 0.2342 28.97); Dark: oklch(59.40% 0.1979 27.86)` | `--danger` | `Button variant="danger"` or `text-danger` for destructive states | Represents destructive, irreversible, or critical actions and states. |
| `success` | `#00CA6C` | `#00CA6C` | `oklch(73.29% 0.1947 154.04)` | `--success` | `text-success` or HeroUI success status components | Communicates positive outcomes, confirmations, and completion states. |
| `warning` | `#F2A71A` | `#F4B94D` | `Light: oklch(78.19% 0.1595 75.56); Dark: oklch(82.03% 0.1396 79.57)` | `--warning` | `text-warning` for caution states | Indicates caution or actions that require attention but are not destructive. |
| `border` | `#DDDEE0` | `#28292A` | `Light: oklch(90.00% 0.0030 280.76); Dark: oklch(28.00% 0.0030 280.76)` | `--border` | `border-border` | Default border color for containers and interactive elements. |
...
| `focus` | `#7F82D4` | `#7F82D4` | `= accent` | `--focus` | Keyboard focus rings | Focus ring color for keyboard navigation indicators. |
| `link` | `#18181B` | `#FCFCFC` | `= foreground` | `--link` | Link text color | Text color for interactive links. |
| `scrollbar` | `#D4D4D6` | `#9FA0A2` | `Light: oklch(87.10% 0.0030 280.76); Dark: oklch(70.50% 0.0030 280.76)` | `--scrollbar` | Scrollbar thumb color | Scrollbar thumb color. |
| `segment` | `#FFFFFF` | `#464648` | `Light: = white; Dark: oklch(39.64% 0.0030 280.76)` | `--segment` | Segmented controls | Background for segmented controls. |
...
| `field-placeholder` | `#717276` | `#9F9FA4` | `= muted` | `--field-placeholder` | Field placeholder text color | Placeholder text color in form fields. |
...
| `chart-1` | `#6E95B0` | `#1A0C56` | `Light: oklch(0.65 0.06 240); Dark: oklch(from var(--accent) calc(l - 0.4) c h)` | `--chart-1` | First chart series color | Chart series color 1. Darkest accent-derived shade for multi-series visualizations. |
| `chart-2` | `#57768C` | `#484793` | `Light: oklch(0.55 0.05 240); Dark: oklch(from var(--accent) calc(l - 0.2) c h)` | `--chart-2` | Second chart series color | Chart series color 2. Mid-dark accent-derived shade. |
| `chart-3` | `#7F82D4` | `#7F82D4` | `= accent` | `--chart-3` | Primary chart series color, aligned with accent | Chart series color 3. Equal to accent — the brand baseline. |
| `chart-4` | `#2C3D49` | `#9194E8` | `Light: oklch(0.35 0.03 240); Dark: oklch(from var(--accent) calc(l + 0.06) c h)` | `--chart-4` | Fourth chart series color | Chart series color 4. Mid-light accent-derived tint. |
| `chart-5` | `#8CB4D1` | `#A3A7FD` | `Light: oklch(0.75 0.06 240); Dark: oklch(from var(--accent) calc(l + 0.12) c h)` | `--chart-5` | Fifth chart series color | Chart series color 5. Lightest accent-derived tint. |
...
| `accent-soft-hover` | `rgba(127, 130, 212, 0.2)` | `rgba(127, 130, 212, 0.16)` | `Light: accent / 20% + transparent; Dark: accent / 16% + transparent` | `--accent-soft-hover` | Prefer the HeroUI token for accent-soft-hover. | Hover state for accent-soft backgrounds. |
...
| `danger-hover` | `#FF5647` | `#E15549` | `danger / 90% + danger-foreground / 10%` | `--danger-hover` | Prefer the HeroUI token for danger-hover. | Hover state for danger backgrounds. |
| `danger-soft` | `rgba(255, 57, 45, 0.15)` | `rgba(219, 60, 51, 0.15)` | `danger / 15% + transparent` | `--danger-soft` | Prefer the HeroUI token for danger-soft. | Subtle danger background for soft emphasis. |
| `danger-soft-foreground` | `#A4352D` | `#EB796B` | `Light: danger / 70% + foreground / 40%; Dark: danger / 80% + foreground / 30%` | `--danger-soft-foreground` | Prefer the HeroUI token for danger-soft-foreground. | Text color on danger-soft backgrounds. |
| `danger-soft-hover` | `rgba(255, 57, 45, 0.2)` | `rgba(219, 60, 51, 0.2)` | `danger / 20% + transparent` | `--danger-soft-hover` | Prefer the HeroUI token for danger-soft-hover. | Hover state for danger-soft backgrounds. |
...
| `success-hover` | `#18B664` | `#18B664` | `success / 90% + success-foreground / 10%` | `--success-hover` | Prefer the HeroUI token for success-hover. | Hover state for success backgrounds. |
| `success-soft` | `rgba(0, 202, 108, 0.15)` | `rgba(0, 202, 108, 0.12)` | `Light: success / 15% + transparent; Dark: success / 12% + transparent` | `--success-soft` | Prefer the HeroUI token for success-soft. | Subtle success background for soft emphasis. |
| `success-soft-foreground` | `#297849` | `#72D994` | `Light: success / 80% + foreground / 60%; Dark: success / 80% + foreground / 30%` | `--success-soft-foreground` | Prefer the HeroUI token for success-soft-foreground. | Text color on success-soft backgrounds. |
| `success-soft-hover` | `rgba(0, 202, 108, 0.2)` | `rgba(0, 202, 108, 0.16)` | `Light: success / 20% + transparent; Dark: success / 16% + transparent` | `--success-soft-hover` | Prefer the HeroUI token for success-soft-hover. | Hover state for success-soft backgrounds. |
...
| `warning-hover` | `#D99723` | `#DBA74A` | `warning / 90% + warning-foreground / 10%` | `--warning-hover` | Prefer the HeroUI token for warning-hover. | Hover state for warning backgrounds. |
| `warning-soft` | `rgba(242, 167, 26, 0.15)` | `rgba(244, 185, 77, 0.12)` | `Light: warning / 15% + transparent; Dark: warning / 12% + transparent` | `--warning-soft` | Prefer the HeroUI token for warning-soft. | Subtle warning background for soft emphasis. |
| `warning-soft-foreground` | `#84602C` | `#F7CC85` | `Light: warning / 80% + foreground / 70%; Dark: warning / 80% + foreground / 30%` | `--warning-soft-foreground` | Prefer the HeroUI token for warning-soft-foreground. | Text color on warning-soft backgrounds. |
| `warning-soft-hover` | `rgba(242, 167, 26, 0.2)` | `rgba(244, 185, 77, 0.16)` | `Light: warning / 20% + transparent; Dark: warning / 16% + transparent` | `--warning-soft-hover` | Prefer the HeroUI token for warning-soft-hover. | Hover state for warning-soft backgrounds. |
...
| --- | --- | --- | --- | --- | --- |
| `font sans` | `var(--font-figtree, "Figtree", sans-serif)` |  | `--font-sans` | Prefer inherited typography from HeroUI components and Tailwind font utilities. | Primary sans font family used by HeroUI components. |
...
| Token | Raw value | Formula / source | HeroUI variable | Tailwind / component equivalent | Purpose |
| --- | --- | --- | --- | --- | --- |
| `spacing` | `4.25px` |  | `--spacing` | Prefer Tailwind spacing utilities like `gap-4`, `p-6`, `px-8`, and `space-y-4`. | Base spacing unit used by the generated Tailwind spacing scale. |
...
| Token | Raw value | Formula / source | HeroUI variable | Tailwind / component equivalent | Purpose |
| --- | --- | --- | --- | --- | --- |
| `radius` | `16px` |  | `--radius` | Prefer Tailwind radius utilities like `rounded-lg`, `rounded-xl`, and `rounded-2xl`. | Global corner radius basis for surfaces, buttons, and container shapes. |
| `field radius` | `32px` |  | `--field-radius` | Prefer HeroUI field components so this radius is applied automatically. | Corner radius basis for inputs, selects, text areas, and other form controls. |
