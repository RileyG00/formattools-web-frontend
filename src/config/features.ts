...
//Formatters
//----------------------------------------------------------------------------------------
export const formatters_Json: FeatureOptionItem = {
...
export const formatters_Xml: FeatureOptionItem = {
	key: getFeatureOptionItemKey(
		featureRoutes.formatters,
...
export const formatters_Html: FeatureOptionItem = {
	key: getFeatureOptionItemKey(
		featureRoutes.formatters,
...
export const formatters_Sql: FeatureOptionItem = {
	key: getFeatureOptionItemKey(
		featureRoutes.formatters,
...
export const formatters_TabularToSql: FeatureOptionItem = {
	key: getFeatureOptionItemKey(
		featureRoutes.formatters,
...
export const formatters_String: FeatureOptionItem = {
	key: getFeatureOptionItemKey(
		featureRoutes.formatters,
...
//Escapers & Encoders
//----------------------------------------------------------------------------------------
export const escapers_Json: FeatureOptionItem = {
	key: getFeatureOptionItemKey(
...
export const escapers_Xml: FeatureOptionItem = {
	key: getFeatureOptionItemKey(
		featureRoutes.escapers_encoders,
...
export const escapers_Url: FeatureOptionItem = {
	key: getFeatureOptionItemKey(
		featureRoutes.escapers_encoders,
...
export const escapers_Base64: FeatureOptionItem = {
	key: getFeatureOptionItemKey(
		featureRoutes.escapers_encoders,
...
//Converters
//----------------------------------------------------------------------------------------
export const converters_EpochDate: FeatureOptionItem = {
	key: getFeatureOptionItemKey(
...
//Ciphers
//----------------------------------------------------------------------------------------
export const ciphers_Griffinere: FeatureOptionItem = {
	key: getFeatureOptionItemKey(
...
//RNGs
//----------------------------------------------------------------------------------------
export const rngs_DiceRoll: FeatureOptionItem = {
	key: getFeatureOptionItemKey(
		featureRoutes.rngs,
...
export const rngs_CoinToss: FeatureOptionItem = {
	key: getFeatureOptionItemKey(
		featureRoutes.rngs,
...
//----------------------------------------------------------------------------------------
//String and Number Generators
//----------------------------------------------------------------------------------------
export const generators_String: FeatureOptionItem = {
	key: getFeatureOptionItemKey(
...
export const generators_Number: FeatureOptionItem = {
	key: getFeatureOptionItemKey(
		featureRoutes.generators,
...
export const generators_LoremIpsum: FeatureOptionItem = {
	key: getFeatureOptionItemKey(
		featureRoutes.generators,
...
export const featureConfigs: FeatureOption[] = [
	...
	},
	{
		...
		items: [escapers_Json, escapers_Xml, escapers_Url, escapers_Base64],
	},
	{
	...
	},
	{
		...
		items: [rngs_DiceRoll, rngs_CoinToss],
	},
	{
